...
```yml
# Site settings
title: Kyle Blog             # title of your website
SEOTitle: Kyle Blog          # check out docs for more detail
...
It's possible that you want the two things different. For me, my site-title is **“Kyle Blog”** but I want the title shows in search engine is **“Kyle的博客 | Kyle Blog”** which is multi-language.
...
- Fixed [issue#15](https://github.com/Huxpro/kylesblog.github.io/issues/15) about code wrap.
